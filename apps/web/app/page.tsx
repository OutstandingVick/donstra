...
export default function Home() {
  return (
    <div id="donstra-app" className="min-h-screen bg-[#080D07] text-[#F3F8F1] antialiased">
      <a href="#main-content" className="fixed start-4 top-4 z-[60] -translate-y-24 rounded-md bg-[#16DB65] px-4 py-3 text-sm font-semibold text-[#071006] focus:translate-y-0 focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-white">Skip to content</a>
      <MarketingHeader />
