...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#0D160B] font-sans text-[#E8EDE6] antialiased selection:bg-[#16DB65]/30">
      <a href="#main-workspace" className="fixed start-3 top-3 z-[60] -translate-y-20 rounded-md bg-[#E8EDE6] px-4 py-2 text-sm font-semibold text-[#0D160B] focus:translate-y-0">Skip to workspace</a>
